...
> dans le dépôt de distribution **[`LokLakh-s/jellycrowd-dist`](https://github.com/LokLakh-s/jellycrowd-dist)**.
...
La distribution publique passe par le dépôt `jellycrowd-dist` (voir le README racine).
